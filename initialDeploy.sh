...
python3 ~/de-serverlessization/log-parser/get-workflow-logs/getWorkflowLogs.py $workflow 1 
...
python3 ~/de-serverlessization/log-parser/get-workflow-logs/getWorkflowLogs.py $workflow 0 &
pidTwo=$!
...
trap "kill ${pidOne} ${pidTwo} ${pidThree} ${pidFour}; python3 ~/de-serverlessization/log-parser/get-workflow-logs/getWorkflowLogs.py ${workflow} 1; python3 ~/de-serverlessization/setup-tests/combineDataframes.py; exit 1" INT SIGINT SIGTERM EXIT
wait
