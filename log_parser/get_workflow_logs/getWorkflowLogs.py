...
class GetWorkflowLogs:
    ...
    def saveResults(self):
        publisheExeIDsPath = os.getcwd()+"/data/"  + str(self.workflow)+ "/"+str(self.count)+", publisheExeIDs.json"
        messageExePath = os.getcwd()+"/data/"  + str(self.workflow)+ "/"+str(self.count)+", messageExe.json"
        dataPath = os.getcwd()+"/data/" + str(self.workflow)+ "/"+str(self.count)+ ', data.json'
