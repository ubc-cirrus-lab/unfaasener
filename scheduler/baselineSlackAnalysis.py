...
class baselineSlackAnalysisClass:
    def __init__(self, workflow):
        ...
        # jsonPath = os.getcwd() + "/log-parser/get_workflow_logs/data/" + self.workflow+".json"
        # dataframePath = os.getcwd() + "/log-parser/get_workflow_logs/data/" + self.workflow + "/NEWWgeneratedData.pkl"
        jsonPath = (
        ...
        # dataframePath = str(Path(os.getcwd()).resolve().parents[0]) + "/log-parser/get_workflow_logs/data/" + self.workflow + "/generatedDataFrame.pkl"
        dfDir = Path(
